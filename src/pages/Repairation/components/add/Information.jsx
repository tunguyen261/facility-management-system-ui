...
import { ASSET_STATUS, PRIORRITY_OPTIONS } from 'utils/constants';
    ...
    <CAAccordion title={title}>
      <div className='ca_col_12'>
        <div className='ca_row'>
          ...
          <FormItem className='ca_col_4' label='Trạng thái' disabled={true || watch('is_internal')}>
            <FormSelect
